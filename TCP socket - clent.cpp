//ATENÇÃO: é necessário adicionar a dependencia: " WS2_32.lib " - ao linker antes de compilar.
//WARNING: it is necessary to add the dependency: " WS2_32.lib " - to the linker before compiling.
